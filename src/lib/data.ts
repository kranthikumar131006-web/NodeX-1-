...
export const startups: Startup[] = [
  {
    ...
    problem: 'Businesses struggle to leverage their data effectively.',
    solution: 'We provide a suite of AI tools to unlock data-driven insights.',
    fundingStage: 'Seed',
    status: 'Funding Open',
    founders: [
        { id: 'f1', name: 'Frank Green', role: 'CEO', avatarUrl: getImage('avatar5').url, imageHint: getImage('avatar5').hint },
    ],
  },
  {
    id: 's2',
    ...
    status: 'Hiring',
    founders: [
        { id: 'f2', name: 'Grace Hopper', role: 'CTO', avatarUrl: getImage('avatar6').url, imageHint: getImage('avatar6').hint },
    ],
  },
  {
    id: 's3',
    ...
    founders: [
        { id: 'f3', name: 'Henry Ford', role: 'Founder', avatarUrl: getImage('avatar7').url, imageHint: getImage('avatar7').hint },
    ],
  },
];
